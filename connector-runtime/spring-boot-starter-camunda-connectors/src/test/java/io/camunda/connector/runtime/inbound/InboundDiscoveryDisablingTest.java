...
@SpringBootTest(
    properties = {
      "camunda.connector.test_class=io.camunda.connector.runtime.inbound.InboundDiscoveryDisablingTest"
    },
...
public class InboundDiscoveryDisablingTest {
  ...
  public static void envSetup() {
    EnvironmentVariablesAdapter.addHardwiredEnvironmentVariable(
        "CONNECTOR_INBOUND_DISCOVERY_DISABLED", "true");
  }
  ...
  public void ensureIsDisabled() {
    ...
    Assertions.assertInstanceOf(
        TestSpringBasedInboundConnector.class,
