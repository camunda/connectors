...
@SpringBootTest(
    ...
    classes = {TestConnectorRuntimeApplication.class, ObjectMapperQualifierTest.TestConfig.class})
public class ObjectMapperQualifierTest {

  @Autowired
  @Qualifier("connectorObjectMapper")
  private ObjectMapper connectorObjectMapper;
  ...
  static class TestConfig {
    /**
     * Additional ObjectMapper bean to simulate user-defined configuration. This should NOT be used
     * by the connector runtime. With the @ConditionalOnMissingBean(name = "connectorObjectMapper")
     * change, the autoconfiguration will create the connectorObjectMapper bean automatically,
     * ignoring this @Primary bean for connector purposes.
     */
    @Bean
    @Primary
    public ObjectMapper customObjectMapper() {
      // Create a basic ObjectMapper without Camunda-specific modules
