...
@Endpoint(id = "processDefinitionCache")
public class ProcessDefinitionCacheEndpoint {

  private final ProcessDefinitionInspector processDefinitionInspector;

  public ProcessDefinitionCacheEndpoint(ProcessDefinitionInspector processDefinitionInspector) {
