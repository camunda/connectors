...
public interface ConnectorsOutboundMetricsContext {

  static CounterMetricsContext counter(ActivatedJob job) {
  ...
  static TimerMetricsContext timer(ActivatedJob job) {
    Result result = Result.getResult(job);
