...
public class ConsoleSecretProviderTest {
  ...
  static void beforeAll() {
    ...
    authToken = Collections.singletonMap("Authorization", "Bearer XXX");
    when(auth.getTokenHeader(Product.ZEEBE)).thenReturn(authToken);
  ...
  void testSuccessfulSecretsHandling() {
    ...
    wm.stubFor(
        get(urlPathMatching("/secrets"))
            .withHeader("Authorization", matching(authToken.get("Authorization")))
