...
import static io.camunda.connector.runtime.test.example.outbound.ExampleTestData.Object;
import static io.camunda.connector.runtime.test.example.outbound.ExampleTestData.ObjectAndListWithSecrets;
import static io.camunda.connector.runtime.test.example.outbound.ExampleTestData.ObjectWithSecret;
import static io.camunda.connector.runtime.test.example.outbound.ExampleTestData.SingleKeyObjectWithSecret;
import static io.camunda.connector.runtime.test.example.outbound.ExampleTestData.SingleKeyObjectWithSecretInParentheses;
import static org.assertj.core.api.Assertions.assertThat;

import io.camunda.connector.runtime.test.example.outbound.ExampleNumberOutboundInput;
import io.camunda.connector.runtime.test.example.outbound.ExampleOutboundFunction;
import io.camunda.connector.runtime.test.example.outbound.ExampleOutboundInput;
