...
@SpringBootTest(
    ...
    properties = {
      // This module's src/test/resources/application.properties shadows the bundle's main one, so
      // the route would be absent and the assertions below would pass on a 404, not the chain.
