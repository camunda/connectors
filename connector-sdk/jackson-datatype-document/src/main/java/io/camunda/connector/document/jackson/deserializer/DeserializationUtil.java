...
public class DeserializationUtil {
  ...
  public static OperationResult.Success<?> requireOperationSuccessOrThrow(
  ...
  public static <T> T requireOperationSuccessOrThrow(OperationResult<?> result, Class<T> clazz) {
