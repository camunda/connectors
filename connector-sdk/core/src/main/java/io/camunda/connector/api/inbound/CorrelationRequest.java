 ...
 *
 * <p>The specified message ID will only be used as a fallback value if a custom message ID expression
 * is not configured in the connector's element template.
 *
 * @see <a
...
public class CorrelationRequest {
   ...
   *                  if a custom message ID expression is not configured in the connector's element
   *                  template.
   */
