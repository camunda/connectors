...
public class FeelContextAwareObjectReader {
  ...
  private FeelContextAwareObjectReader(ObjectMapper mapper) {
    this.mapper = mapper;
  }

  public static FeelContextAwareObjectReader of(ObjectMapper mapper) {
    return new FeelContextAwareObjectReader(mapper);
  }
