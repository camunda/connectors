  ...
  static Provider openaiDirect(
    ...
    return new Provider(
        ...
        Map.of(
            "provider.type",
            "openai",
            "provider.openai.apiFamily",
            apiFamily,
            "provider.openai.backend.type",
            "direct",
            "provider.openai.backend.apiKey",
    ...
    return Stream.of(
            ...
            anthropicDirect(
                ...
                Map.of(
                    ...
                    Capability.WEB_SEARCH, Map.of("provider.anthropic.enableWebSearch", "true"),
                    Capability.CODE_INTERPRETER,
                        Map.of("provider.anthropic.enableCodeExecution", "true")),
                false),
            ...
            openaiDirect(
                ...
                Map.of(
                    ...
                    Capability.REASONING, Map.of("provider.openai.model.parameters.effort", "high"),
                    Capability.WEB_SEARCH, Map.of("provider.openai.enableWebSearch", "true"),
                    Capability.CODE_INTERPRETER,
                        Map.of("provider.openai.enableCodeInterpreter", "true")),
                true),
            ...
            openaiDirect(
                ...
                Map.of(
                    ...
                    Capability.PROMPT_CACHING, Map.of(),
                    Capability.REASONING,
                        Map.of("provider.openai.model.parameters.effort", "high")),
                true),
