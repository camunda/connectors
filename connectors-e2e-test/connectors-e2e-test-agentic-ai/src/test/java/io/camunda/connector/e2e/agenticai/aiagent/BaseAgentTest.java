...
public abstract class BaseAgentTest extends BaseAgenticAiTest {
  ...
  public static Path httpsKeystoreFile() {
    final var resource =
        BaseAgentTest.class.getResource("/wiremock-https/wiremock-https-keystore.p12");
    if (resource == null) {
  ...
  // across every subclass of BaseAgentTest.
  @RegisterExtension
