...
//
// import static
// io.camunda.connector.e2e.agenticai.aiagent.langchain4j.Langchain4JAiAgentToolSpecifications.MCP_TOOL_SPECIFICATIONS;
...
//
//  @Mock(answer = Answers.RETURNS_DEEP_STUBS) private McpClientDelegate aMcpClient;
//  @Mock(answer = Answers.RETURNS_DEEP_STUBS) private McpClientDelegate aRemoteMcpClient;
//  @Mock(answer = Answers.RETURNS_DEEP_STUBS) private McpClientDelegate aRemoteMcpClient2;
//
...
//                      "{\"paramC1\": \"someOtherValue\"}", toolExecutionRequest.arguments(),
// true);
//                }));
//  }
//
