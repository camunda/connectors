...
/** Adapts {@link BedrockConverseRecordedConversation.RecordedChatRequest} to the SPI shape. */
final class BedrockConverseRecordedChatRequestAdapter implements RecordedChatRequest {

  private final BedrockConverseRecordedConversation.RecordedChatRequest delegate;

  BedrockConverseRecordedChatRequestAdapter(
      BedrockConverseRecordedConversation.RecordedChatRequest delegate) {
  ...
  private record ToolCallAdapter(BedrockConverseRecordedConversation.RecordedToolCall delegate)
