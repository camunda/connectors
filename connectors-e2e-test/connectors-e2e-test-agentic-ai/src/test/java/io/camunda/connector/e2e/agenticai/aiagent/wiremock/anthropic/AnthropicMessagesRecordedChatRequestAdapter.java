...
/** Adapts {@link AnthropicMessagesRecordedConversation.RecordedChatRequest} to the SPI shape. */
final class AnthropicMessagesRecordedChatRequestAdapter implements RecordedChatRequest {

  private final AnthropicMessagesRecordedConversation.RecordedChatRequest delegate;

  AnthropicMessagesRecordedChatRequestAdapter(
      AnthropicMessagesRecordedConversation.RecordedChatRequest delegate) {
  ...
  private record ToolCallAdapter(AnthropicMessagesRecordedConversation.RecordedToolCall delegate)
