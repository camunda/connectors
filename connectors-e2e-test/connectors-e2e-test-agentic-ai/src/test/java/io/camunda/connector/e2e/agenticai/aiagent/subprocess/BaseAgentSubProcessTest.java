 ...
 *
 * <p>Mirror of {@link BaseAgentTaskTest} for the job-worker flavor.
 */
@SlowTest
public abstract class BaseAgentSubProcessTest extends BaseAgentTest {
  ...
  protected ZeebeTest testBasicExecutionWithoutFeedbackLoop(
      ...
      ThrowingConsumer<AgentSubProcessResponse> agentResponseAssertions)
      throws Exception {
  ...
  protected void assertAgentResponse(
      ZeebeTest zeebeTest, ThrowingConsumer<AgentSubProcessResponse> assertions) {
        ...
        .hasVariableSatisfies(
            ...
            agentResponseMap -> {
              final var agentResponse =
                  objectMapper.convertValue(agentResponseMap, AgentSubProcessResponse.class);
