...
public class PostmanQueryUtil {
  ...
  public static Set<HttpOperationProperty> transformToQueryParamProperty(Endpoint endpoint) {
    Set<HttpOperationProperty> queryParams = new HashSet<>();
    Optional.ofNullable(endpoint.request().url().queryParams())
