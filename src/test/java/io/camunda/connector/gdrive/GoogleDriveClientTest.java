...
class GoogleDriveClientTest {
  ...
  @Test
  public void createByMetaData_shouldCreateFileByMetaData() throws IOException {
    // Given
  ...
  public void createByTemplate_shouldCreateNewFileFromTemplate(String templateId)
      throws IOException {
    // Given
  ...
  public void replaceVariables_shouldExecuteUpdateDocumentMethod(String fileId) throws IOException {
    // Given
