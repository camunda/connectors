...
[LocalConnectorRuntime](../apps/bundle/default-bundle/src/test/java/io/camunda/connector/runtime/app/LocalConnectorRuntime.java)
...
- Add it to the `dependencyManagement` section of [bundle parent POM](../apps/bundle/pom.xml)
- Add it to the `dependencies` section of [default bundle POM](../apps/bundle/default-bundle/pom.xml)
