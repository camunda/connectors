...
public record DetailedConnection(
    ...
    @TemplateProperty(
            ...
            tooltip =
                "Additional properties for the connection. See the <a href=\"https://docs.camunda.io/docs/8.9/components/connectors/out-of-the-box-connectors/sql/#connection\" target=\"_blank\">SQL connection properties</a> reference.")
        @FEEL
