...
/** Additional content offered for a Microsoft Teams recipient: an Adaptive Card, or a form. */
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "type")
@JsonSubTypes({
  @JsonSubTypes.Type(value = AdditionalContent.None.class, name = "none"),
  @JsonSubTypes.Type(value = AdditionalContent.AdaptiveCard.class, name = "adaptiveCard"),
...
public sealed interface TeamsExtra extends AdditionalContent
    permits AdditionalContent.None, AdditionalContent.AdaptiveCard, AdditionalContent.Form {}
