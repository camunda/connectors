...
@JsonSubTypes({
  ...
  @JsonSubTypes.Type(
      value = InboundSchemaRegistryStrategy.class,
      name = InboundSchemaRegistryStrategy.TYPE)
})
public sealed interface InboundSchemaStrategy
    permits NoSchemaStrategy, AvroInlineSchemaStrategy, InboundSchemaRegistryStrategy {}
