...
class ListChatMembersTest extends BaseTest {

  @ParameterizedTest
  @MethodSource("listChatMembersValidationFailTestCases")
  public void validate_shouldThrowExceptionWhenAtLeastOneRequiredFieldNotExist(String input) {
    ...
    assertThat(request.getData()).isInstanceOf(ListChatMembers.class);
