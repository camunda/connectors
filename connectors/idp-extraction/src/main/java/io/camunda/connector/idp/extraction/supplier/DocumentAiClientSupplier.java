...
public class DocumentAiClientSupplier {
  ...
  public DocumentProcessorServiceClient getDocumentAiClient(DocumentAIProvider baseRequest)
      throws IOException {
    DocumentProcessorServiceSettings settings =
        DocumentProcessorServiceSettings.newBuilder()
            .setCredentialsProvider(() -> GcsUtil.getCredentials(baseRequest.getAuthentication()))
            .build();
