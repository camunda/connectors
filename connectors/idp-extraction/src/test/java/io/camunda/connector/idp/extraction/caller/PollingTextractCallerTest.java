...
class PollingTextractCallerTest {
    ...
    void beforeEach() {
        ...
        awsS3UtilMockedStatic.when(() -> AwsS3Util.buildS3ObjectFromUrl(any(), any(String.class), any(S3AsyncClient.class)))
                .thenReturn(s3Object);
        awsS3UtilMockedStatic.when(() -> AwsS3Util.deleteS3ObjectFromBucketAsync(any(), any(String.class), any(S3AsyncClient.class)))
    ...
    void callTextractDocumentAnalysisWithSuccess() throws Exception {
        ...
        String extractedText = new PollingTextractCaller()
    ...
    void callTextractDocumentAnalysisWithFailure() {
        ...
        Exception exception = assertThrows(
                ConnectorException.class, () -> pollingTextractCaller
                        .call("test Url", "test-aws-s3-bucket-name", textractClient, s3AsyncClient)
        );
