...
public class TaskPollerImpl implements TaskPoller {
  ...
  @Override
  public CompletableFuture<A2AClientSendMessageResult> poll(
      String taskId, Client client, Duration pollInterval, Duration timeout) {
    CompletableFuture<A2AClientSendMessageResult> future = new CompletableFuture<>();
        ...
        new Runnable() {
          ...
          public void run() {
            ...
            try {
              ...
              } else if (result.state().isCompleted()) {
