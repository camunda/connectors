...
public class ChatModelProviderRegistryImpl implements ChatModelProviderRegistry {

  private static final Logger LOGGER = LoggerFactory.getLogger(ChatModelProviderRegistryImpl.class);

  private final Map<String, ChatModelProvider> chatModelProviders = new HashMap<>();

  public ChatModelProviderRegistryImpl() {}

  public ChatModelProviderRegistryImpl(List<ChatModelProvider> chatModelProviders) {
