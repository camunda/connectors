...
/**
 * Shared helpers for output truncation and binary detection used by the sandbox function. Design
 * §7a: binary content is never returned raw — a marker string is substituted.
 */
final class OutputBounds {

  static final int DEFAULT_TIMEOUT_SECONDS = 60;
  static final long DEFAULT_MAX_OUTPUT_BYTES = 1_048_576;
   ...
   * @param truncated pre-truncated flag (when true, the marker is always appended)
