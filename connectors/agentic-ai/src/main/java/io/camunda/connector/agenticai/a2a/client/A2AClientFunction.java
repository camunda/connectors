...
@ElementTemplate(
    ...
    description =
        "Agent-to-Agent (A2A) client, enabling discovering remote agents' Agent Cards as well as sending messages to remove agents. Compatible with 8.8.0-alpha8 or later.",
    engineVersion = "^8.8",
    version = 0,
