 ...
 *
 * <p>Used to materialize skill bundles into the sandbox filesystem at CREATE time. The resolved
 * skills' files are written to {@code .agents/skills/<name>/} in the sandbox workspace.
 *
