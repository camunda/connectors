 ...
 * is populated only for model-side terminal failures (refusal, content filter, malformed
 * tool-use) where {@code stopReason == ERROR}; transport / SDK / auth failures complete the
 * future exceptionally instead.
 *
