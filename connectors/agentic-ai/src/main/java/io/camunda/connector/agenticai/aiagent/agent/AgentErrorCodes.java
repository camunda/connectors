...
public interface AgentErrorCodes {
  ...
  String ERROR_CODE_AGENT_INSTANCE_CREATION_FAILED = "AGENT_INSTANCE_CREATION_FAILED";
  String ERROR_CODE_AGENT_INSTANCE_UPDATE_FAILED = "AGENT_INSTANCE_UPDATE_FAILED";
}
