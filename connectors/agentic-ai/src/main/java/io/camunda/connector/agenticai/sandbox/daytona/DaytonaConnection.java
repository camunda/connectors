...
/**
 * Daytona connection and sandbox lifecycle settings.
 *
...
public record DaytonaConnection(
  ...
  /**
   * Returns the auto-delete interval in minutes for the Daytona API, or {@code null} if auto-delete
   * is disabled.
   *
   * <ul>
  ...
  /**
   * Auto-stop lifecycle settings. Bound under {@code data.daytona.autoStop.*}.
   *
                  ...
                  @TemplateProperty.PropertyCondition(
                      ...
                      allMatch = {
                        @NestedPropertyCondition(
                            property = "data.daytona.autoStop.mode",
                            equals = "DURATION")
                      }))
          @Nullable String duration) {}

  /**
   * Auto-archive lifecycle settings. Bound under {@code data.daytona.autoArchive.*}.
   *
      ...
      @TemplateProperty(
              ...
              condition =
                  @TemplateProperty.PropertyCondition(
                      ...
                      allMatch = {
                        @NestedPropertyCondition(
                            property = "data.daytona.autoArchive.mode",
                            equals = "DURATION")
                      }))
          @Nullable String duration) {}

  /**
   * Auto-delete lifecycle settings. Bound under {@code data.daytona.autoDelete.*}.
   *
   * @param mode {@link AutoDeleteMode#DISABLED} (never), {@link AutoDeleteMode#IMMEDIATELY} (delete
   *     right after stopping), or {@link AutoDeleteMode#DURATION}.
      ...
      @TemplateProperty(
              ...
              condition =
                  @TemplateProperty.PropertyCondition(
                      ...
                      allMatch = {
                        @NestedPropertyCondition(
                            property = "data.daytona.autoDelete.mode",
                            equals = "DURATION")
                      }))
          @Nullable String duration) {}
