...
public record ToolDefinition(
  ...
  /** Metadata key used to mark a tool definition as an internal sandbox tool. */
  ...
  /** Returns {@code true} if this tool definition is marked as an internal sandbox tool. */
  @JsonIgnore
