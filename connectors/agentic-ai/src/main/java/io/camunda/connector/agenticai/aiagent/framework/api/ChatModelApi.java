 ...
 *
 * <p>Implementations drive the underlying SDK's streaming endpoint internally and expose a
 * blocking {@link CompletableFuture} surface to callers. The optional {@link ChatStreamListener}
 * receives discriminated stream events for in-process observability.
 *
