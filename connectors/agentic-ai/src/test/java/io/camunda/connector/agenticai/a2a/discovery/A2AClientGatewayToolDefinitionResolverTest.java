...
class A2AClientGatewayToolDefinitionResolverTest {

  @Test
  void resolvesGatewayToolDefinitionsFromElementsWithA2AClientProperty() {
    A2AClientGatewayToolDefinitionResolver resolver = new A2AClientGatewayToolDefinitionResolver();
    final var elements =
        List.of(
  ...
  private AdHocToolElement withA2AClientProperty(AdHocToolElement element) {
    return withGatewayType(element, A2AClientGatewayToolHandler.GATEWAY_TYPE);
  }
