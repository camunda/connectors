...
class SystemPromptComposerImplTest {
  ...
  void shouldComposeWithSingleContributor() {
    SystemPromptContributor contributor = (agentCtx) -> "Additional instructions";
  ...
  void shouldComposeWithMultipleContributorsInOrder() {
    SystemPromptContributor contributor1 =
        new SystemPromptContributor() {
          @Override
          public String contributeSystemPrompt(AgentContext agentCtx) {
  ...
  void shouldSkipNullOrEmptyContributions(String contribution) {
    SystemPromptContributor contributor1 = (agentCtx) -> "Valid contribution";
    SystemPromptContributor contributor2 = (agentCtx) -> contribution;
    SystemPromptContributor contributor3 = (agentCtx) -> "Another valid";
  ...
  void shouldHandleEmptyBasePrompt() {
    SystemPromptContributor contributor = (agentCtx) -> "Contribution";
    SystemPromptComposer composer = new SystemPromptComposerImpl(List.of(contributor));
