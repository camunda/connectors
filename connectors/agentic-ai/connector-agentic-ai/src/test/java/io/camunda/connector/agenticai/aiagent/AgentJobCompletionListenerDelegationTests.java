...
class AgentJobCompletionListenerDelegationTests {
  ...
  class TaskResponseDelegationTests {
    ...
    void onJobCompleted_noOpWithNullListener() {
      var response = new AgentTaskConnectorResponse(null, null);
  ...
  class SubProcessResponseDelegationTests {
    ...
    private AgentSubProcessConnectorResponse buildResponse(AgentJobCompletionListener listener) {
