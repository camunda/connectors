...
@AgenticAiRecord
public record AgentSubProcessConnectorResponse(
    ...
    implements AdHocSubProcessConnectorResponse,
        ...
        AgentSubProcessConnectorResponseBuilder.With {

  public static AgentSubProcessConnectorResponseBuilder builder() {
    return AgentSubProcessConnectorResponseBuilder.builder();
  }
