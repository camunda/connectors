...
/**
 * The outcome of a single round-trip performed by a {@link ChatModel}: the assistant message
...
public sealed interface ChatResult {
  ...
  record Completed(AssistantMessage assistantMessage, AgentMetrics metrics) implements ChatResult {}
