...
carries a self-generated `id()`, independent of any provider-issued id (see
[ADR 012](../adr/012-stable-self-generated-message-ids.md)). A random id is generated once, at
...
than being re-derived. Messages persisted before this field existed get backfilled with a fresh id
