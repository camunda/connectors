...
class OpenSearchVectorStoreFactoryTest {
  ...
  class OpenSearchVectorStoreTests {
          ...
          credentialsProvider -> {
            ...
            var osCredentials =
                credentialsProvider.getCredentials(
                    new AuthScope(
                        new HttpHost(ProxyConfiguration.HTTPS, OPENSEARCH_HOST, OPENSEARCH_PORT)),
                    null);
    ...
    void configureOpenSearchProxyWithoutCredentials() {
      var proxyDetails =
          new ProxyConfiguration.ProxyDetails(
              ProxyConfiguration.HTTPS, PROXY_HOST, PROXY_PORT, null, null);
      ...
      testOpenSearchConfiguration(
          ...
          credentialsProvider -> {
            ...
            var proxyCredentials =
                credentialsProvider.getCredentials(
                    new AuthScope(new HttpHost(ProxyConfiguration.HTTPS, PROXY_HOST, PROXY_PORT)),
                    null);
    ...
    void configureOpenSearchProxyWithCredentials() {
      var proxyDetails =
          new ProxyConfiguration.ProxyDetails(
              ProxyConfiguration.HTTPS, PROXY_HOST, PROXY_PORT, PROXY_USERNAME, PROXY_PASSWORD);
      ...
      testOpenSearchConfiguration(
          ...
          credentialsProvider -> {
            ...
            var osCredentials =
                credentialsProvider.getCredentials(
                    new AuthScope(new HttpHost(ProxyConfiguration.HTTPS, "opensearch.local", 9200)),
                    null);
            assertThat(osCredentials).isNotNull();
            ...
            var proxyCredentials =
                credentialsProvider.getCredentials(
                    new AuthScope(
                        new HttpHost(ProxyConfiguration.HTTPS, "proxy.example.com", 8080)),
                    null);
  ...
  class AmazonManagedOpenSearchVectorStoreTests {
    ...
    private void testAmazonManagedOpenSearchConfigurationWithProxy(
      ...
      try (var apacheHttpClientStatic = mockStatic(ApacheHttpClient.class);
        ...
        verify(proxyConfig).getProxyDetails(ProxyConfiguration.HTTPS);
        verify(proxyConfig, never()).getProxyDetails(ProxyConfiguration.HTTP);
        verify(awsProxyConfigBuilder).scheme(ProxyConfiguration.HTTPS);
