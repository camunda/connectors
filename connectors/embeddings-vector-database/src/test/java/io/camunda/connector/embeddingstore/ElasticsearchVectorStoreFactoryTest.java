        ...
        credentialsProvider -> {
          ...
          var esCredentials =
              credentialsProvider.getCredentials(
                  new AuthScope(new HttpHost("elastic.local", 9200, ProxyConfiguration.HTTPS)));
        ...
        credentialsProvider -> {
          ...
          var esCredentials =
              credentialsProvider.getCredentials(
                  new AuthScope(
                      new HttpHost(
                          ELASTICSEARCH_HOST, ELASTICSEARCH_PORT, ProxyConfiguration.HTTPS)));
          assertThat(esCredentials).isNotNull();
          assertThat(esCredentials).isInstanceOf(UsernamePasswordCredentials.class);
          assertThat(((UsernamePasswordCredentials) esCredentials).getUserName())
          ...
          var proxyCredentials =
              credentialsProvider.getCredentials(
                  new AuthScope(new HttpHost(PROXY_HOST, PROXY_PORT, ProxyConfiguration.HTTPS)));
