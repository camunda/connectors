...
class AzureVectorStoreFactoryTest {

  AzureVectorStoreFactory factory = new AzureVectorStoreFactory();
    ...
    private void testAzureCosmosDbNoSqlEmbeddingStoreCreation(
      ...
      try (var mockStore =
        ...
        ClosableEmbeddingStore<TextSegment> embeddingStore =
            factory.createCosmosDbNoSqlVectorStore(vectorStore, mockModel);
  ...
  class AzureAiSearchVectorStoreTests {
    ...
    private void testAzureAiSearchEmbeddingStoreCreation(
      ...
      try (var mockStore =
        ...
        factory.createAiSearchVectorStore(
