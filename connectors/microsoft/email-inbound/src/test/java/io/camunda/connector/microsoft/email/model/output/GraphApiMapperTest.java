...
class GraphApiMapperTest {
  ...
  @Test
  void toMessageWithMetadata_mapsCommonFieldsAndKeepsMetadata() {
    ...
    var result = GraphApiMapper.toMessageWithMetadata(message, List.of(pdf));
  ...
  @Test
  void toMessageWithMetadata_withoutMetadata_yieldsEmptyList() {
    var message = new Message();
    message.setId("msg-2");

    var result = GraphApiMapper.toMessageWithMetadata(message, List.of());

    assertThat(result.attachmentMetadata()).isEmpty();
  }

  @Test
  void toMessageWithAttachments_copiesCommonFieldsAndSetsDocuments() {
    var source =
    ...
    var result = GraphApiMapper.toMessageWithAttachments(source, List.of(downloaded));
