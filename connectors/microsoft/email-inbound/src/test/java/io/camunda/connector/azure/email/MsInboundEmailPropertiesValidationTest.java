...
import io.camunda.connector.azure.email.model.config.EmailPollingConfig;
import io.camunda.connector.azure.email.model.config.EmailProcessingOperation;
import io.camunda.connector.azure.email.model.config.FilterCriteria;
import io.camunda.connector.azure.email.model.config.Folder;
import io.camunda.connector.azure.email.model.config.InboundAuthentication;
    ...
    void validate_shouldFail_whenMoveOperationTargetFolderNameIsBlank() {
      ...
      var properties =
          new MsInboundEmailProperties(
              validAuthentication(),
              validPollingConfig(),
              new EmailProcessingOperation.MoveOperation(new Folder("", false)));
    ...
    void validate_shouldSucceed_withMoveOperation() {
      ...
      var properties =
          new MsInboundEmailProperties(
              validAuthentication(),
              validPollingConfig(),
              new EmailProcessingOperation.MoveOperation(new Folder("archive", false)));
