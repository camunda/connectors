...
public class TestMessage extends Message {
  ...
  public static class TestMessageBuilder {
    ...
    public TestMessageBuilder setFrom(List<String> from) {
      this.from = from;
      return this;
    }

    public TestMessageBuilder setStrings(List<String> strings) {
    ...
    public TestMessage createTestMessage() {
      return new TestMessage(messageId, subject, from, strings, cc, sentAt, receivedAt, size, body);
    }
  }
}
