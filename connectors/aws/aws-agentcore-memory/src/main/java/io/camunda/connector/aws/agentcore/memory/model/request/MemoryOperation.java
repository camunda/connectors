...
@JsonSubTypes({
  @JsonSubTypes.Type(value = RetrieveMemoryRecordsOperation.class, name = "retrieve"),
})
...
public sealed interface MemoryOperation permits RetrieveMemoryRecordsOperation {}
