...
public sealed interface ComprehendRequestData
  ...
  ComprehendDocumentReadAction getDocumentReadAction();

  ComprehendDocumentReadMode getDocumentReadMode();

  boolean getFeatureTypeTables();

  boolean getFeatureTypeForms();
}
