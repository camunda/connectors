...
class DeleteColumnOperationTest extends BaseTest {
  ...
  @DisplayName("Should delete column by number index")
  @Test
  void deleteColumn_shouldDeleteColumnByNumberIndex() throws IOException {
    ...
    try (MockedStatic<GoogleSheetsServiceSupplier> mockedServiceSupplier =
      ...
      assertEquals(COLUMN_INDEX + 1, range.getEndIndex());
  ...
  @DisplayName("Should delete column by letter index")
  @Test
